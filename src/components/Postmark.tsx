...
/** The cancellation mark: double ring, city arced over the top, wavy tail. */
export function Postmark({ city, date }: PostmarkProps) {
  const arcId = useId();
  return (
    <svg className="cancel" width="90" height="90" viewBox="0 0 92 92" aria-hidden="true">
      <g transform="rotate(-9 46 46)" fill="none" stroke="var(--postmark)" strokeWidth="1.6">
      ...
      <g transform="rotate(-9 46 46)">
        ...
        <text fontFamily="Courier New, monospace" fontSize="7.6" letterSpacing="1.1" fill="var(--postmark)">
